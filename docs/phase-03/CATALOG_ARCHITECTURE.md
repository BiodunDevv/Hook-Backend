...
- Market Associate owns mutable submission drafts for actively assigned Markets.
...
- `ProductSubmission` (`SUB`): Market Associate evidence, Market/State provenance, variants, media, review feedback, optimistic version.
...
Public presenters expose public IDs, customer content, effective prices, media, variants, category, Market, and State only. Base price, margin, floors, Market Associate identity, source Vendor references, review notes, Mongo IDs, and audit data are excluded.
