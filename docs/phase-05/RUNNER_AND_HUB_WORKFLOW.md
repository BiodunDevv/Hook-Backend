# Runner And Hub Workflow

## Runner states

`ALERTED -> ACCEPTED -> SOURCING -> PRODUCT_SECURED -> PACKING -> READY_FOR_HUB`

The Runner account, active Market assignment, State, task version, and evidence
...
Hub staff must receive with the Runner credential and then record visible QC.
