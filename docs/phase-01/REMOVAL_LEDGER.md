...
| Field Agent naming                 | Active UI/API/permissions used inconsistent Field Agent wording.                                                                                                             | Persisted `field_agent` role and model retained.                  | Active term is Market Associate through compatibility mapping.      |
