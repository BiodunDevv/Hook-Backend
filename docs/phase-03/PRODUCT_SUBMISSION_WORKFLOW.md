...
Market Associate creation derives State from the assigned Market. Submission requires an active Market Associate, active Market assignment, title, category suggestion, base price in minor units, availability, at least one owned ready media asset, and variants.
