...
- Account-specific operations live in Staff, Market Associate, and Hook Partner profiles.
...
- Staff, Market Associate, and Hook Partner accounts are created in `invited` state without an administrator-known password.
...
- Staff, Market Associate, and Partner activation routes remain isolated in their respective route groups.
