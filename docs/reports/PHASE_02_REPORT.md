...
- Atomic annual public IDs for State, City, Zone, Market, Hub, Partner, Market Associate, Customer, Staff, and Audit.
...
- Operation State, City, Zone, Market, Dispatch Hub, Hook Partner, Market Associate, and assignment domains.
- Append-only sanitized audit foundation.
- Admin operational and governance routes plus isolated Market Associate and Partner foundations.
...
- Secure single-use activation invitations for Staff, Market Associate, and Partner accounts, with isolated activation routes, audited acceptance, and resend controls.
- Relationship-aware State and City selectors for City, Zone, Market, Hub, and Partner administration.
- Permission-aware staff console plus isolated Market Associate and Partner route groups. Super Admin remains an RBAC role inside the staff console rather than a duplicated dashboard application.
- Searchable relationship selectors for Staff roles, State scope, Hub scope, and Market Associate State scope, backed by active-record and geographic compatibility validation.
- Audited Staff, Market Associate, Partner, State, City, Zone, Market, and Hub lifecycle controls, including explicit invitation cancellation.
...
- Platform State, City, Zone, Market, Hub, Partner, Market Associate, Staff, assignment, and authenticated scope responses now present public relationship identifiers while retaining internal Mongo references for persistence and authorization.
- City, Zone, Market, Hub, Partner, Market Associate, and assignment mutations normalize public identifiers and enforce geographic compatibility on both create and update paths.
